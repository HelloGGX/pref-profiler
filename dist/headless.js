...
export function setNonInteractiveSession(value) {
 ...
 */
export function getHeadlessTurnMetrics() {
...
export function logHeadlessProfilerTurn() {
    ...
    if (DETAILED_PROFILING) {
        logForDebugging(`[headlessProfiler] Turn ${currentTurnNumber} metrics: ${JSON.stringify(metadata)}`);
    }
}
